...
Angenommen, du triffst mit Claude Code eine wichtige Architekturentscheidung und hältst sie im Project Brain fest.
...
2. Dauerhafte Entscheidungen und bestätigtes Wissen werden im Project Brain gehalten.
3. Die Claude-Code-Sitzung endet.
4. Kein verstecktes Claude-Memory wird zu Codex kopiert.
5. Du startest Codex im selben Projektordner.
6. Livariant erzeugt eine Codex-spezifische Resume-Projektion aus dem Project Brain.
7. Codex erhält die aktuellen Entscheidungen, bekannten Fakten, Ziele, offenen Fragen und den Lifecycle-Kontext, den Livariant für Resume bereitstellt.
