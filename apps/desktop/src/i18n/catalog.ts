...
export const messages = {
  ...
  "projectBrain.description": { segment: "projectBrain", en: "A clear view over Livariant's existing Project Brain: inspect current knowledge, tell Livariant what changed and review every canonical update before it is accepted.", de: "Eine klare Sicht auf Livariants bestehendes Project Brain: Wissen prüfen, Änderungen mitteilen und jede kanonische Aktualisierung vor der Übernahme kontrollieren." },
  "projectBrain.currentProject": { segment: "projectBrain", en: "Current project", de: "Aktuelles Projekt" },
  "projectBrain.noProjectSelected": { segment: "projectBrain", en: "No project selected", de: "Kein Projekt ausgewählt" },
  "projectBrain.search": { segment: "projectBrain", en: "Search Project Brain areas…", de: "Project-Brain-Bereiche durchsuchen…" },
  "projectBrain.confirmedAreas": { segment: "projectBrain", en: "Confirmed areas", de: "Bestätigte Bereiche" },
  "projectBrain.needsReview": { segment: "projectBrain", en: "Needs review", de: "Prüfung nötig" },
  "projectBrain.knowledgeGaps": { segment: "projectBrain", en: "Knowledge gaps", de: "Wissenslücken" },
  "projectBrain.potentialConflicts": { segment: "projectBrain", en: "Potential conflicts", de: "Mögliche Konflikte" },
  "projectBrain.curatedAreas": { segment: "projectBrain", en: "Curated areas", de: "Kuratierte Bereiche" },
  "projectBrain.curatedTitle": { segment: "projectBrain", en: "Work with Project Brain without growing an endless list", de: "Mit Project Brain arbeiten, ohne eine endlose Liste aufzubauen" },
  ...
  "projectBrain.projectPurpose": { segment: "projectBrain", en: "Project purpose", de: "Projektzweck" },
  "projectBrain.direction": { segment: "projectBrain", en: "Direction", de: "Ausrichtung" },
  "projectBrain.currentDirection": { segment: "projectBrain", en: "Current direction", de: "Aktuelle Ausrichtung" },
  "projectBrain.rules": { segment: "projectBrain", en: "Rules", de: "Regeln" },
  "projectBrain.rulesConstraints": { segment: "projectBrain", en: "Rules & constraints", de: "Regeln & Grenzen" },
