...
const copy = (german: boolean): SettingsCopy => german ? {
  ...
  foundation: "App-Einstellungen",
  foundationDetail: "Allgemeine Einstellungen bleiben bewusst kompakt, während weitere Produktfunktionen konfigurierbar werden.",
  ready: "Bereit",
  systemDetail: "Technische Versions- und Runtime-Informationen werden hier gebündelt, statt normale Arbeitsseiten zu belegen.",
  systemFoundation: "Desktop-Vorschau",
  ...
  foundationDetail: "General preferences remain intentionally small while product behavior becomes configurable.",
  ready: "Ready",
  systemDetail: "Technical version and runtime information will live here instead of occupying normal work pages.",
  systemFoundation: "Desktop preview",
